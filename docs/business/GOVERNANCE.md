...
| **AI agents** | Implement stories per [`AGENTS.md`](../../AGENTS.md); never leave work uncommitted or untested |
...
1. Story ID referenced in code comments and [`USER_STORIES.md`](../../USER_STORIES.md)
...
4. Docs updated (README/ARCHITECTURE where behavior changed) + [`WORK.md`](../../WORK.md) session note
...
2. **Architecture changes** (new deps, new modules, schema) are discussed in the story
   before implementation — see the rules in [`AGENTS.md`](../../AGENTS.md)
